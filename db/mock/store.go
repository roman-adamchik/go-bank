...
// Source: github.com/roman-adamchik/simplebank/db/sqlc (interfaces: Store)
//
...
// AddAccountBalanceParams mocks base method.
func (m *MockStore) AddAccountBalanceParams(ctx context.Context, arg db.AddAccountBalanceParamsParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAccountBalanceParams", ctx, arg)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// AddAccountBalanceParams indicates an expected call of AddAccountBalanceParams.
func (mr *MockStoreMockRecorder) AddAccountBalanceParams(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddAccountBalanceParams", reflect.TypeOf((*MockStore)(nil).AddAccountBalanceParams), ctx, arg)
}
